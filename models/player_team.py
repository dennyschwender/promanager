...
role, position, shirt number and membership status."""
...
class PlayerTeam(Base):
    ...
    __table_args__ = (UniqueConstraint("player_id", "team_id", name="uq_player_team"),)
    ...
    injured_until: Mapped[date | None] = mapped_column(Date, nullable=True)    # When True the player is absent by default for this team's events;
    # can still be overridden at individual event level.
    ...
    def __repr__(self) -> str:
        return (
            ...
            f"team_id={self.team_id} priority={self.priority}>"
        )
